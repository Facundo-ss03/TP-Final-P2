...
public class Ticketek implements ITicketek{
	...
	public void registrarSede(String nombre, String direccion, int capacidadMaxima) {
		...
		try {
			...
			throw new RuntimeException("Ocurrió un error al registrar un estadio.", ex);
		}
	...
	public void registrarSede(String nombre, String direccion, int capacidadMaxima, int asientosPorFila,
		...
		try {
			...
			throw new RuntimeException("Ocurrió un error al registrar un teatro.", ex);
		}
	...
	public void registrarSede(String nombre, String direccion, int capacidadMaxima, int asientosPorFila,
		...
		try{
			...
			throw new RuntimeException("Ocurrió un error al registrar un mini teatro.", ex);
		}
	...
	public void registrarUsuario(String email, String nombre, String apellido, String contrasenia) {
		...
		try {
			...
			throw new RuntimeException("Ocurrió un error al registrar el usuario.", ex);
		}
	}
	...
	public void registrarEspectaculo(String nombre) {
		...
		try {
			...
			if(espectaculos.containsKey(nombre)){
				...
				throw new RuntimeException("Error al registrar un espectaculo", ex);
		}		
	}
	...
	public void agregarFuncion(String nombreEspectaculo, String fechaFuncion, String nombreSede, double precioBase) {
		...
		try {
			...
			throw new RuntimeException("Ocurrió un error al agregar una función.", ex);	
		}
	...
	public List<IEntrada> venderEntrada(String nombreEspectaculo, String fecha, String email, String contrasenia,
		...
		try {
			...
			throw new RuntimeException("Ocurrió un error en el procesamiento de la venta", ex);
		}
	...
	public List<IEntrada> venderEntrada(String nombreEspectaculo, String fecha, String email, String contrasenia,
		...
		try {
			...
			throw new RuntimeException("Ocurrió un error en el procesamiento de la venta de entradas.", ex);
		}
	}
	...
	public String listarFunciones(String nombreEspectaculo) {
		...
		try {
			...
			if(epectaculoValido(nombreEspectaculo)){
				...
				throw new RuntimeException("Error: el nombre de espectaculo ingresado es inválido.");
			}

		} catch (Exception ex) {
			throw new RuntimeException("Ocurrió un error al intentar listar las funciones del espectaculo", ex);
		}
	...
	public List<IEntrada> listarEntradasEspectaculo(String nombreEspectaculo) {
		...
		try {
			...
			throw new RuntimeException("Ocurrió un error al intentar listar las entradas compradas de un espectáculo.", ex);
		}
	}
	...
	public List<IEntrada> listarEntradasFuturas(String email, String contrasenia) {
		try {
			...
			throw new RuntimeException("Ocurrió un error al intentar listar entradas futuras", ex);
		}
	}
	...
	public List<IEntrada> listarTodasLasEntradasDelUsuario(String email, String contrasenia) {
		...
		try {
			...
			throw new RuntimeException("Ocurrió un error al intentar listar entradas", ex);
		}
	...
	public boolean anularEntrada(IEntrada entrada, String contrasenia) {
		...
		if(entrada == null) {
			throw new RuntimeException("Error: la entrada ingresada es nula.");
		}
		...
		if(entrada.getClass() == Entrada.class){
			...
			if(user.validarContraseña(contrasenia)){
				...
				throw new RuntimeException("Error: la contraseña ingresada es incorrecta.");
			}
	...
	public IEntrada cambiarEntrada(IEntrada entrada, String contrasenia, String fecha, String sector, int asiento) {
		...
		try {
			...
			throw new RuntimeException("Ocurrió un error al intentar cambiar la entrada.", ex);
		}
	}
	...
	public IEntrada cambiarEntrada(IEntrada entrada, String contrasenia, String fecha) {		
		...
		try {
			...
			if(usuarioValido(entradaAntigua.getEmail(), contrasenia)){
				...
				Espectaculo espectaculo = espectaculos.get(entradaAntigua.getEspectaculo());
				espectaculo.eliminarEntrada(entradaAntigua);	//elimino la entrada del espectaculo, liberando el asiento.
	...
	public double costoEntrada(String nombreEspectaculo, String fecha) {
		...
		try {
			...
			throw new RuntimeException("Ocurrió un error al intentar obtener el costo de la entrada", ex);
		}
	...
	public double totalRecaudado(String nombreEspectaculo) {
		try {
			...
			throw new RuntimeException("Ocurrió un error al intentar obtener la recaudación de un espectaculo.", ex);
		}
	}
	...
	public double totalRecaudadoPorSede(String nombreEspectaculo, String nombreSede) {
		...
		try {
			...
			if(espectaculos.containsKey(nombreEspectaculo)){
				...
				throw new RuntimeException("Ocurrió un error al intentar obtener la recaudación de una sede.", ex);
		}
